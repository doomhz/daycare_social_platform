(function() {
  ...
  window.Kin.Header.NotificationView = (function(_super) {
    ...
    NotificationView.prototype.changeHandler = function(attribute, value) {
      if (attribute === this.indicatorId) this.updateIndicator(value);
      if (attribute === this.listId) return this.updateList(value);
    };
